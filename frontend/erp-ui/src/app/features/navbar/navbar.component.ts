        ...
        <div class="relative top-nav__profile-wrapper">
          ...
          >
            ...
            <a
              ...
              class="inline-flex w-full items-center justify-center gap-2 rounded-full bg-slate-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-700"
            ...
            <button
              type="button"
              class="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-full bg-rose-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-rose-700"
